...
///////////////////////////////////////////////
	 ...
	 */
	public static void testGoogleTranslate(boolean async) throws IOException {
		Map params = new HashMap();
		params.put("id", "3");
		params.put("page", "1");
		params.put("langpair", "en|zh-CN");
		String url = "https://www.tingdao.org/index/Sermon/Sermon";
		...
		String responseText = ajax.getResponseText();
